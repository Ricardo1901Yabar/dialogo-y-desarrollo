...
<head>
    ...
    <title>Alianzas - DDP Noticias</title>
...
<header id="site-header" class="fixed-top">
  <div class="container">
      <nav class="navbar navbar-expand-lg stroke">
          <a class="navbar-brand" href="index.php"><img src="./index_files/logo.png" alt="Logo" style="height:75px;"></a>
...
<section class="breadcrumb-area py-5" style="margin-top: 90px;">
    <div class="container py-5 text-center">
        <h2 class="title-big">Alianzas Estratégicas</h2>
        <p class="mt-3 text-muted">Contenido en construcción.</p>
    </div>
</section>
</body>
</html>